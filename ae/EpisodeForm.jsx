...
(function episodeForm(thisObj) {
    ...
    function build(thisObj) {
        ...
        // Filled in for real by updateOrderHelp() once Read has run and the
        // counts are known - until then there is nothing true to say.
        var orderHelp = win.add("statictext", undefined,
            "اضغط Read الأول، وبعدين اكتب هنا مين قال كل اقتباس.\n\n",
            { multiline: true });
        ...
        function doSave() {
            ...
            // The files are on disk by the time this runs - the write happens
            // above and nothing here can undo it. Opening on a warning made it
            // read as a refusal, so it got pressed again against a folder that
            // had been correct all along. Say what happened, then what is
            // still missing.
            alert("\u2705  \u0627\u062a\u062d\u0641\u0638: quotes.csv" +
                  (info !== "" ? " \u0648 episode-info.txt" : "") + "\n" +
                  dest.fsName + "\n\n" +
                  headline + "\n\n" + fix + "\n\n" +
                  "\u0645\u0646 \u063a\u064a\u0631 \u062f\u0647 \u0627\u0644\u0643\u0631\u0648\u062a \u0647\u062a\u0637\u0644\u0639 \u0645\u0646 \u063a\u064a\u0631 \u0623\u0633\u0627\u0645\u064a \u2014 " +
                  "\u0648\u062a\u0642\u062f\u0631 \u0628\u062f\u0644 \u0643\u062f\u0647 \u062a\u0641\u062a\u062d quotes.csv " +
                  "\u0648\u062a\u0645\u0644\u0627 \u0639\u0645\u0648\u062f \u0627\u0644\u0645\u062a\u062d\u062f\u062b \u0628\u0625\u064a\u062f\u0643.");

            // and put the cursor where the answer goes
            try { orderTxt.active = true; } catch (eFocus) {}
        }
